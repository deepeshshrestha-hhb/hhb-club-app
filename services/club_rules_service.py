...
DEFAULT_SECTIONS = {
    "rotation": (
        ...
        "<tbody>"
        "<tr><td><strong>1</strong><br><span class=\"text-muted small\">Top Court</span></td>"
        ...
        "<tr><td><strong>4</strong><br><span class=\"text-muted small\">Improvers Court</span></td>"
    ...
    "sitting_out": (
        ...
        "places with them directly, and let the board-keeper know.</li>"
        "</ul>"
